...
do
    ...
    for V in 1 0.1 0.01 
    do 
        papermill ABC_GAN-Stats.ipynb ./ABC_GAN/ABC-GAN_output_${runs}_${i}.ipynb -p variance ${V} 
        ((i=i+1))
    done 
done
...
#     for V in 1 0.1 0.01 
#     do 
#         papermill ABC_GAN-Catboost.ipynb ./ABC_GAN_Output/ABC-GAN_output_${runs}_${i}.ipynb -p variance ${V} 
#         ((i=i+1))
#     done 
# done
